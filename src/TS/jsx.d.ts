...
declare global {
	namespace JSX {
		...
		type Component<T> = (props: Record<string, unknown>, scope: Scope<T>) => Element;
...
declare function jsx(element: JSX.ElementType, props: { [K in string]: unknown }, children: Child): Instance;
export = jsx;
